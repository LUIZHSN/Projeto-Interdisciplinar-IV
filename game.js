...
Game.prototype.display = function(){
	...
	this.ctx.font="20px Fascinate, sans-serif";
	this.ctx.fillText("Pontos Maximos : " +this.maxScore, 10, 50);
	this.ctx.fillText("Pontos: " + this.score, 10, 25);
	this.ctx.fillText("Rodada: " +this.generation, 10, 75);
